  ...
  return (
    <DashboardLayout activeMenu="manage-jobs">
      ...
      {loading && (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="mt-4 text-blue-600">Loading Applications</p>
          </div>
        </div>
      )}
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        {/* main content */}
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-0 pb-8">
          {Object.keys(groupedApplications).length === 0 ? (
            // Empty state
            <div className="text-center py-16">
              <Users className="mx-auto h-24 w-24 text-green-300" />
                  ...
                  <div className="p-6">
                    <div className="space-y-4">
                      {applications.map((application) => (
                        <div
                          key={application._id}
                          className="flex flex-col md:flex-row md:items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors duration-300"
                        >
                          <div className="flex items-center gap-4">
                            ...
                            <div className="flex-shrink-0">
                              {application.applicant.avatar ? (
                                ...
                                <div className="h-15 w-15 rounded-full bg-blue-200 flex items-center justify-center">
                          ...
                          <div className="flex items-center gap-3 mt-4 md:m-0">
                            ...
                            <button
                              ...
                              className="inline-flex items-center gap-2 px-3 py-2 bg-blue-700 text-white text-sm font-medium rounded-lg hover:bg-blue-800 transition-colors duration-300"
                            >
                            ...
                            <button
                              ...
                              className="inline-flex items-center gap-2 px-3 py-2 bg-gray-200 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-300 transition-colors duration-300"
                            >

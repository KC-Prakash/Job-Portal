      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl md:text-6xl font-bold text-green-700 hover:text-green-600 mb-4 sm:mb-6 leading-tight"
          >
          ...
          >
            Your journey to success starts here. Explore opportunities, connect with top companies,
